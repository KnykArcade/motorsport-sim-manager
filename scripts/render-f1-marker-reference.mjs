...
function card([key, primary, secondary, number, features], index) {
  ...
  return `<g>
    ...
    <text x="${x + 364}" y="${y + 112}" fill="#f7f7f7" font-family="Arial Narrow,Arial,sans-serif" font-size="14" font-weight="900">EXACT 40 PX GAME MARKER</text>
...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="1600" height="980" viewBox="0 0 1600 980">
  ...
  <text x="38" y="54" fill="#f5c400" font-family="Arial Narrow,Arial,sans-serif" font-size="34" font-weight="900">F1 LIVE TRACK MARKERS — APPROVED ARTWORK BUILD</text>
  <text x="38" y="88" fill="#d0d3d7" font-family="Arial Narrow,Arial,sans-serif" font-size="17" font-weight="800">1990s / 2000s / 2010s / 2020s · EXACT SOURCE PIXELS · 40 PX · FRONT-NOSE NUMBERS ONLY</text>
  ${eras.map(card).join('')}
  <rect x="28" y="948" width="1536" height="2" fill="#f5c400" opacity=".65"/>
  <text x="38" y="971" fill="#8d949c" font-family="Arial Narrow,Arial,sans-serif" font-size="12" font-weight="700">LOCKED REFERENCE: THE MOCKUP AND GAME LOAD THE SAME NUMBERLESS RASTER MASTER FOR EACH ERA.</text>
</svg>`;
