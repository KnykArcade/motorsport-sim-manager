...
export type RaceContext = {
  ...
  // Sporting consequences generated by post-qualifying setup-rule decisions.
  // Grid consequences are already reflected in qualifyingResults; drive-through
  // consequences are consumed identically by Quick Sim and Live Race.
  preRaceSetupPenaltiesByDriver?: Record<string, import('./raceRulesTypes').SetupPenaltyConsequence>;
};
