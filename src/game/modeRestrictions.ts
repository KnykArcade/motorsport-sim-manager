...
const SINGLE_SEASON_BLOCKED_ACTIONS = new Set([
  ...
  'SIGN_SPONSOR',
  'DROP_SPONSOR',
  'START_SPONSOR_RENEWAL',
  'SUBMIT_SPONSOR_NEGOTIATION',
  'ACCEPT_SPONSOR_COUNTER',
  'CANCEL_SPONSOR_NEGOTIATION',
  'TERMINATE_SPONSOR',
  'SELECT_BOARDROOM_MANDATE',
  'REQUEST_BOARD_FUNDING',
  'SIGN_YOUTH',
  'PROMOTE_ACADEMY',
  'RELEASE_ACADEMY',
  ...
  'START_MARKET_CONTRACT_NEGOTIATION',
  'UPDATE_MARKET_CONTRACT_NEGOTIATION',
  'SUBMIT_MARKET_CONTRACT_NEGOTIATION',
  'START_STAFF_CONTRACT_NEGOTIATION',
  'UPDATE_STAFF_CONTRACT_NEGOTIATION',
  'SUBMIT_STAFF_CONTRACT_NEGOTIATION',
  'ADVANCE_SEASON',
  'ACCEPT_JOB_OFFER',
  'DECLINE_JOB_OFFER',
  'SET_REGULATION_VOTE',
