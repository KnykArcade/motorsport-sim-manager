// Synchronous season data access for tests and tools.
// This module statically imports ALL season bundles, so it should ONLY be
// used in test files — never in production app code, which should use
// the async seasonLoader.ts instead.
...
import { season1995 } from './seasons/season1995';
