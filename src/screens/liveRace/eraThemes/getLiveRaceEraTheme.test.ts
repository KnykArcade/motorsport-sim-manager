...
describe('getLiveRaceEraTheme', () => {
  it('uses the F1 1990s live race theme for 1990-1999 F1 seasons', () => {
    ...
    expect(shouldUseF11990sLiveRaceScreen('F1', 2020)).toBe(true);
    expect(shouldUseF11990sLiveRaceScreen('IndyCar', 1995)).toBe(true);
    expect(shouldUseF11990sLiveRaceScreen('IndyCar', 2010)).toBe(true);
  });
  ...
  it('falls back safely with missing season data', () => {
    ...
    expect(shouldUseF11990sLiveRaceScreen('NASCAR', 2020)).toBe(true);
    expect(shouldUseF11990sLiveRaceScreen(undefined, undefined)).toBe(true);
  });
});
